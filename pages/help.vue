<template>
  <section class="container help">
    ...
    <div class="grid grid-cols-1 gap-4 xl:gap-6 xl:grid-cols-4">
      <div class="p-4 x xl:p-12 xl:col-span-4 rounded-3xl help__annotation">
        <p class="max-w-4xl">
      ...
      <div
        class="flex flex-col items-center px-6 py-12 space-y-5 text-center x rounded-3xl"
      >
      ...
      <div
        class="flex flex-col items-center px-3 py-12 space-y-5 text-center x rounded-3xl"
      >
      ...
      <div class="p-4 x xl:p-12 xl:col-span-4 rounded-3xl">
...
<script>
import AppSpoiler from '~/components/ui/app-spoiler.vue'
export default {
  components: {
    AppSpoiler,
  },
...
.help {
  &__annotation {
    background: url('/img/bg-help.svg') right bottom no-repeat,
      var(--x_bg-secondary);
  }
