...
const settings = {
  ...
  't-modal': {
    ...
    props: {
      fixedClasses: {
        ...
        close:
          'flex text-white items-center opacity-30 hover:opacity-100 justify-center absolute right-4 top-4 h-8 w-8 transition duration-100 ease-in-out focus:ring-2 focus:ring-primary focus:outline-none focus:ring-opacity-50',
  ...
  't-button': {
    ...
    props: {
      fixedClasses:
        'block border px-4 py-2 border-transparent placeholder-opacity-5 rounded focus:border-primary focus:ring-2 focus:ring-primary focus:outline-none focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-400',
      classes: 'text-white border border-transparent rounded font-bold',
      variants: {
        primary:
          'min-h-primary text-dark bg-primary uppercase font-bold text-xs hover:bg-primary-hover cursor-not-allowed',
